...
### The following is an automated LEDAW procedure for obtaining BSSE-uncorrected DLPNO-CCSD(T)/LED inter-strand 
...
main_filenames = [r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SuperSys.out', 
                          r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SubSysK.out',
                          r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SubSysL.out',
                 ]
...
LEDAW_output_path = r'../LEDAW-OUT/DNA-DLPNO-woBSSE/NBODY'
...
onebody_out_directory = r'../orca-outputs/DNA-DLPNO/ONEBODY'
...
LEDAW_output_path_twobody = r'../LEDAW-OUT/DNA-DLPNO-woBSSE/TWOBODY'
...
cooperativity_engine(base_path=r'../LEDAW-OUT/DNA-DLPNO-woBSSE', nbody_dir_name='NBODY', twobody_dir_name='TWOBODY', directory_level=1)
...
heatmap_plot_engine_no_gui(base_path=r'../LEDAW-OUT/DNA-DLPNO-woBSSE', 
