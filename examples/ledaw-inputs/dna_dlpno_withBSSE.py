...
main_filenames = [r'../ORCA-OUT/DNA-DLPNO/NBODY-ALL/SuperSys.out', 
                          r'../ORCA-OUT/DNA-DLPNO/NBODY-ALL/SubSysK-BSSE.out',
                          r'../ORCA-OUT/DNA-DLPNO/NBODY-ALL/SubSysL-BSSE.out',
                 ]
...
two_body_orcaout_directory = r'../ORCA-OUT/DNA-DLPNO/TWOBODY'
