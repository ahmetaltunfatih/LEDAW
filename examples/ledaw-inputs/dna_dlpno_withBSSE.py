...
### The following is an automated LEDAW procedure for obtaining BSSE-corrected DLPNO-CCSD(T)/LED inter-strand 
...
main_filenames = [r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SuperSys.out', 
                          r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SubSysK-BSSE.out',
                          r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SubSysL-BSSE.out',
                 ]
...
LEDAW_output_path = r'../LEDAW-OUT/DNA-DLPNO-withBSSE/NBODY'
...
supersystem_file = r'../orca-outputs/DNA-DLPNO/NBODY-ALL/SuperSys.out'
reduced_relabel_mapping = get_reduced_relabel_mapping(supersystem_file=supersystem_file, relabel_mapping=relabel_mapping)
onebody_out_directory = r'../orca-outputs/DNA-DLPNO/ONEBODY-BSSE'
...
two_body_orcaout_directory = r'../orca-outputs/DNA-DLPNO/TWOBODY'


### Specify the Directory where LEDAW will write Two-Body LED Matrices
LEDAW_output_path_twobody = r'../LEDAW-OUT/DNA-DLPNO-withBSSE/TWOBODY'
...
cooperativity_engine(base_path=r'../LEDAW-OUT/DNA-DLPNO-withBSSE', nbody_dir_name='NBODY', twobody_dir_name='TWOBODY', directory_level=1)
...
heatmap_plot_engine_no_gui(base_path=r'../LEDAW-OUT/DNA-DLPNO-withBSSE', 
